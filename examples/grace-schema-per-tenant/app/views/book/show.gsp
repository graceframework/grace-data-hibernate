...
<html>
    ...
    <div id="content" role="main">
        <div class="container">
            <section class="row">
                <a href="#show-book" class="skip" tabindex="-1"><g:message code="default.link.skip.label" /></a>
            ...
            <section class="row">
                <div id="show-book" class="col-12 scaffold scaffold-show" role="main">
                    ...
                    <g:form resource="${this.book}" method="DELETE">
                        <fieldset class="buttons offset-3">
                            <g:link class="btn btn-primary" action="edit" resource="${this.book}">
