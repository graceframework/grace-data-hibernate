GORM classes also support Hibernate's query language HQL, a very complete reference for which can be found link:{hibernateuserguide}/html_single/Hibernate_User_Guide.html#hql[in the Hibernate documentation] of the Hibernate documentation.

GORM provides a number of methods that work with HQL including link:{gormapi}/org/grails/datastore/gorm/GormEntity.html#find(java.lang.String)[find], link:{gormapi}/org/grails/datastore/gorm/GormEntity.html#findAll(java.lang.String)[findAll] and link:{gormapi}/org/grails/datastore/gorm/GormEntity.html#executeQuery(java.lang.String)[executeQuery].
