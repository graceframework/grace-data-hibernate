...
The same pagination and sorting parameters available on the link:{gormapi}/org/grails/datastore/gorm/GormEntity.html#list()[list()] method can also be used with dynamic finders by supplying a map as the final parameter:
