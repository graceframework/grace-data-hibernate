...
NOTE: Because the setting is Groovy configuration it must go into a Groovy-aware configuration format. This can be `app/conf/application.groovy` in Grace, or `src/main/resources/application.groovy` in Spring Boot.
