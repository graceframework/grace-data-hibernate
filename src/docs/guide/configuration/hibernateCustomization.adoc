...
The `HibernateConnectionSourceFactory` has a few useful setters that allow you to specify a Hibernate link:{hibernatejavadoc}/org/hibernate/Interceptor.html[Interceptor] or link:{hibernatejavadoc}/org/hibernate/boot/spi/MetadataContributor.html[MetadataContributor] (Hibernate 5+ only).
