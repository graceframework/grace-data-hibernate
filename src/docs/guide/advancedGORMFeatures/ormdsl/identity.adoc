...
NOTE: For more information on the different Hibernate generators refer to the link:{hibernateuserguide}/html_single/Hibernate_User_Guide.html#identifiers-generators[Hibernate reference documentation]
